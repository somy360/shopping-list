...
Recipe _recipeDeserialize(
  ...
  final object = Recipe(
    ...
    instructions: reader.readStringOrNull(offsets[1]),
...
extension RecipeQueryWhere on QueryBuilder<Recipe, Recipe, QWhereClause> {
  ...
  QueryBuilder<Recipe, Recipe, QAfterWhereClause> nameIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Recipe, Recipe, QAfterWhereClause> nameIsNotNull() {
    return QueryBuilder.apply(this, (query) {
